...
I2SMicrophoneComponent::I2SMicrophoneComponent() {
}
...
void I2SMicrophoneComponent::setup() {
...
bool I2SMicrophoneComponent::raw_read_sample(int16_t *left_data, int16_t *right_data, bool blocking) {
